    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expire_data', models.ImageField(default=1, upload_to='', verbose_name='有效期')),
                ...
                ('entry_way', models.SmallIntegerField(choices=[(0, '短信换票入院'), (1, '凭借验证码入园')], default=0, verbose_name='入园方式')),
                ('tips', models.TextField(blank=True, null=True, verbose_name='预订须知')),
                ('remark', models.TextField(blank=True, null=True, verbose_name='其他说明')),
                ('status', models.SmallIntegerField(choices=[(1, '开放够买'), (0, '暂未开放')], default=1, verbose_name='状态')),
                ('sight', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='sight.sight', verbose_name='景点门票')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('entry_explain', models.CharField(blank=True, max_length=1024, null=True, verbose_name='参数说明')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reply_comments', to='sight.comment', verbose_name='回复')),
